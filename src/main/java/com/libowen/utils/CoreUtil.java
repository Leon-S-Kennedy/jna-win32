...
public class CoreUtil {
    ...
    public static WinNT.HANDLE getProcessHandle(String lpClassName,String lpWindowName) {
        WinDef.HWND windowHandle = getWindowHandle(lpClassName, lpWindowName);
    ...
    public static void readMemoryByPointer(WinNT.HANDLE handle, BasePointer basePointer, Memory buffer) {
        Pointer address = calcAddress(handle, basePointer);
    ...
    public static void writeMemoryByPointer(WinNT.HANDLE handle, BasePointer basePointer, Memory buffer) {
        ...
        Pointer pointer = calcAddress(handle, basePointer);
        writeProcessMemoryByAddress(handle, pointer, buffer);
    }

    public static Pointer calcAddress(WinNT.HANDLE handle, BasePointer basePointer) {
    ...
    public static ValueLockTask valueLock(WinNT.HANDLE handle, BasePointer basePointer,Memory buffer,Long interval) {
        Pointer pointer = calcAddress(handle, basePointer);
        readProcessMemoryByAddress(handle,pointer,buffer);
        ValueLockTask valueLockTask = new ValueLockTask(handle, pointer, buffer, interval);
        executorService.submit(valueLockTask);
        return valueLockTask;
    }
